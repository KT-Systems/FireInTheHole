...
//extern I2C_HandleTypeDef hi2c2;         /* Mcu dependent I2C handler */
extern SPI_HandleTypeDef BMSCommSPI;         /* Mcu dependent SPI handler */
...
#define CS_PIN GPIO_PIN_0            /* Mcu dependent chip select */
